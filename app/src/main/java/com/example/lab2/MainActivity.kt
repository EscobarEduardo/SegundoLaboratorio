//Laboratorio II Programacion IV Kevin Eduardo Escobar Escobar
    ...
    fun registrar(v: View) {
        ...
        if (!nombre.isEmpty() && !edad.isEmpty() && !departamento.isEmpty()) {
            ...
            val adaptador: ArrayAdapter<String> =
                ArrayAdapter<String>(this, R.layout.activity_main, nombres)
            ...
            lvNombres.onItemClickListener = object : AdapterView.OnItemClickListener {
                override fun onItemClick(
                    ...
                    tvDatos.text =
                        "Los datos son: Nombre: ${lvNombres?.getItemAtPosition(position)} Edad: ${edades[position]} Departamento: ${departamentos[position]}"
                }
            }
